...
def rootToLeafPathsSumToK(root, k, lst):
    ...
    if root.left==None and root.right==None and k==root.data:
        for i in lst:
            print(i,end=" ")
        print(root.data,end="\n")
        return
    ...
    rootToLeafPathsSumToK(root.left,k-root.data,lst+[root.data])
    rootToLeafPathsSumToK(root.right,k-root.data,lst+[root.data])
